...
function routes(req, res, params, logger) {
    ...
    try {
        ...
        console.log("normalized Error",JSON.stringify(err));
        console.log("clientInfo" ,JSON.stringify(clientInfo,3,null));
        console.log("params", JSON.stringify(params,3,null));
        log.error('could not normalize request', { error: err.stack });
        return routesUtils.responseXMLBody(
